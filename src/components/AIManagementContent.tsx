...
import { ChatBubbleLeftRightIcon, CogIcon, SparklesIcon } from '@heroicons/react/24/outline'
        ...
        <>
            ...
            <div className="mb-8">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">Configure and monitor AI therapy models</p>
                    </div>
                </div>
            </div>
            ...
            <div className="text-center py-16">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    Advanced AI model configuration and monitoring tools are coming soon! You'll be able to fine-tune responses and track performance.
                </p>
