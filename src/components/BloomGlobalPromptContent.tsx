...
export default function BloomGlobalPromptContent() {
  ...
  // return <div className="h-[85vh] bg-orange-600">
  //   {
  //     Array.from({length: 15}).map(item => <div className="h-[200px] w-full bg-yellow-500 mb-4 overflow-hidden">asd</div>)
  //   }
  // </div>
  ...
  return (
    <>
      {/* Page Header */}
      <div className="mb-8">
        <div className="flex flex-col !mb-4 md:flex-row items-center justify-between">
          <div className="flex flex-col md:flex-row items-start md:items-center space-x-4 mb-4">
          ...
          <div className="flex flex-wrap gap-4 items-center space-x-3">
            ...
            >
              ...
              {isGeneratingPrompt ? "Generating..." : "View Prompt"}
            </button>
            <button
              onClick={savePrompt}
              disabled={isSaving}
