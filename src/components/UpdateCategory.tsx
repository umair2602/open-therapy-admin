...
export default function UpdateCategory({
  ...
  const handleUpdateEmotion = (index: number, field: keyof Emotion, value: string) => {
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Update Emotional Category</h3>
                  <p className="text-blue-100 text-sm">Edit category details, emotions, and AI prompts</p>
                </div>
              </div>
              <button
                onClick={onClose}
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={emotion.name}
                            onChange={(e) => handleUpdateEmotion(index, 'name', e.target.value)}
                      ...
                      <div className="mt-3">
                        ...
                        <textarea
                          ...
                          onChange={(e) => handleUpdateEmotion(index, 'prompt', e.target.value)}
                          rows={2}
